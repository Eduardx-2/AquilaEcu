...
```console
# La versión más completa de este proyecto solo se encuentra disponible en las releases del proyecto, descargue y compilelo usando java, la versión extensa fue desarrollada solo para linux.
# clonar el repo
