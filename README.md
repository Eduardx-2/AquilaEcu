# AQUILAECU
Es un proyecto desarrollado en Java y Python, cuyo objetivo es la extracción de información a partir de placas de automóviles. Los datos obtenidos provienen de fuentes abiertas y públicas (OSINT).
<p align="center">
...
```console
# La versión más completa de este proyecto solo se encuentra disponible en las realeses del proyecto, descargue y compilelo usando java, la versión extensa fue desarrollada solo para linux.
# clonar el repo
